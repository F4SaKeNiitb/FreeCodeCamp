...
ALTER TABLE ONLY public.star DROP CONSTRAINT star_planet_id_fkey;
...
ALTER TABLE ONLY public.planet DROP CONSTRAINT planet_moon_id_fkey;
ALTER TABLE ONLY public.moon DROP CONSTRAINT moon_planet_id_fkey;
ALTER TABLE ONLY public.galaxy DROP CONSTRAINT galaxy_star_id_fkey;
...
DROP SEQUENCE public.more_info_more_info_id_seq;
